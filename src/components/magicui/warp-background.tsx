...
export const WarpBackground: React.FC<WarpBackgroundProps> = ({
  ...
  return (
    <div
      className={cn("relative flex flex-col flex-grow p-4 md:p-8", className)}
      {...props}
    >
      <div
        style={
        ...
        className="pointer-events-none fixed left-0 top-0 w-full overflow-visible [clipPath:inset(0)] [container-type:size] [perspective:var(--perspective)] [transform-style:preserve-3d]"
      >
        {/* top side */}
